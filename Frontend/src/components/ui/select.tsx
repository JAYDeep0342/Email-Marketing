...
/**
 * Select — shadcn/ui primitive built on Radix Select.
 *
 * Same visual language as dropdown-menu.tsx (popover bg/border, the same
 * animate-in/out + zoom data-state classes) so the two feel like one
 * family — a status filter dropdown and a "..." action menu should look
 * like they belong to the same app.
 */
